...
# Model 3: single effects+ 2 way + wrist_ACC_X:wrist_ACC_Y:wrist_ACC_Z + chest_ACC_X:chest_ACC_Y:chest_ACC_Z
...
#Model 5: single effects + wrist_ACC_X:wrist_ACC_Y:wrist_ACC_Z + chest_ACC_X:chest_ACC_Y:chest_ACC_Z + chest_Temp:chest_EDA + chest_ECG:chest_Resp + wrist_EDA:wrist_Temp + wrist_BVP:wrist_Temp+ wrist_BVP:wrist_EDA
...
#Model 6: single effects+quadratic
...
save(an5, file="ANOVA_for_m1_vs_m6_(all).RData")
save(an6, file="ANOVA_for_m1_vs_m7_(all).RData")
